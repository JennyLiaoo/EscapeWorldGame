...
public class Sprite {
    ...
    public void setVelocity(PVector s) { 
        velocity = s; 
    }
    ...
    public void up() {
       position = position.add(new PVector(0, -5));
    }
     public void down() {
        position = position.add(new PVector(0, 5));
    }
     public void left() {
        position = position.add(new PVector(-5, 0));
    }
     public void right() {
        position = position.add(new PVector(5, 0));
    }
    ...
    public boolean checkCollision(Sprite other) {
        ...
        boolean result = myBounds.intersects(otherBounds);
        return result;
    }
    ...
    public boolean checkCollision(Obstacle obstacle) {
        double obstacleX = obstacle.getXPos();
        double obstacleY = obstacle.getYPos();
        double spriteX = position.getXComp();
        double spriteY = position.getYComp();
        
        if (obstacleX == spriteX && obstacleY == spriteY) {
            return true;
        }
        else {
            return false;
